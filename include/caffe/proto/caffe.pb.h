...
class SelectSegBinaryParameter;
class LossParameter;
...
class RedSoftmaxWithLossParameter;
class ReLUParameter;
...
enum LayerParameter_LayerType {
  ...
  LayerParameter_LayerType_BIN_ACCURACY = 49,
  LayerParameter_LayerType_BN = 43,
  ...
  LayerParameter_LayerType_IMAGE_SEG_DATA = 46,
  ...
  LayerParameter_LayerType_RED_SOFTMAX_LOSS = 44,
  LayerParameter_LayerType_RED_ACCURACY = 45,
  LayerParameter_LayerType_RELU = 18,
  LayerParameter_LayerType_SELECT_SEG_BINARY = 52,
  ...
  LayerParameter_LayerType_UNPOOLING = 42,
  LayerParameter_LayerType_WINDOW_DATA = 24,
  LayerParameter_LayerType_WINDOW_CLS_DATA = 50,
  LayerParameter_LayerType_WINDOW_SEG_DATA = 47,
  LayerParameter_LayerType_WINDOW_SEG_BINARY = 51,
  LayerParameter_LayerType_WINDOW_INST_SEG_DATA = 48,
...
const LayerParameter_LayerType LayerParameter_LayerType_LayerType_MAX = LayerParameter_LayerType_DROPOUT_CHANNEL;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  static const LayerType BIN_ACCURACY = LayerParameter_LayerType_BIN_ACCURACY;
  ...
  static const LayerType DROPOUT_CHANNEL = LayerParameter_LayerType_DROPOUT_CHANNEL;
  ...
  static const LayerType ELTWISE_ACCURACY = LayerParameter_LayerType_ELTWISE_ACCURACY;
  ...
  static const LayerType IMAGE_SEG_DATA = LayerParameter_LayerType_IMAGE_SEG_DATA;
  ...
  static const LayerType RED_SOFTMAX_LOSS = LayerParameter_LayerType_RED_SOFTMAX_LOSS;
  static const LayerType RED_ACCURACY = LayerParameter_LayerType_RED_ACCURACY;
  static const LayerType RELU = LayerParameter_LayerType_RELU;
  static const LayerType SELECT_SEG_BINARY = LayerParameter_LayerType_SELECT_SEG_BINARY;
  ...
  static const LayerType WINDOW_CLS_DATA = LayerParameter_LayerType_WINDOW_CLS_DATA;
  static const LayerType WINDOW_SEG_DATA = LayerParameter_LayerType_WINDOW_SEG_DATA;
  static const LayerType WINDOW_SEG_BINARY = LayerParameter_LayerType_WINDOW_SEG_BINARY;
  static const LayerType WINDOW_INST_SEG_DATA = LayerParameter_LayerType_WINDOW_INST_SEG_DATA;
  ...
  // optional .caffe.BinaryAccuracyParameter binary_accuracy_param = 48;
  inline bool has_binary_accuracy_param() const;
  inline void clear_binary_accuracy_param();
  static const int kBinaryAccuracyParamFieldNumber = 48;
  inline const ::caffe::BinaryAccuracyParameter& binary_accuracy_param() const;
  inline ::caffe::BinaryAccuracyParameter* mutable_binary_accuracy_param();
  inline ::caffe::BinaryAccuracyParameter* release_binary_accuracy_param();
  inline void set_allocated_binary_accuracy_param(::caffe::BinaryAccuracyParameter* binary_accuracy_param);
  ...
  // optional .caffe.RedSoftmaxWithLossParameter red_softmax_loss_param = 46;
  inline bool has_red_softmax_loss_param() const;
  inline void clear_red_softmax_loss_param();
  static const int kRedSoftmaxLossParamFieldNumber = 46;
  inline const ::caffe::RedSoftmaxWithLossParameter& red_softmax_loss_param() const;
  inline ::caffe::RedSoftmaxWithLossParameter* mutable_red_softmax_loss_param();
  inline ::caffe::RedSoftmaxWithLossParameter* release_red_softmax_loss_param();
  inline void set_allocated_red_softmax_loss_param(::caffe::RedSoftmaxWithLossParameter* red_softmax_loss_param);

  // optional .caffe.RedAccuracyParameter red_accuracy_param = 47;
  inline bool has_red_accuracy_param() const;
  inline void clear_red_accuracy_param();
  static const int kRedAccuracyParamFieldNumber = 47;
  inline const ::caffe::RedAccuracyParameter& red_accuracy_param() const;
  inline ::caffe::RedAccuracyParameter* mutable_red_accuracy_param();
  inline ::caffe::RedAccuracyParameter* release_red_accuracy_param();
  inline void set_allocated_red_accuracy_param(::caffe::RedAccuracyParameter* red_accuracy_param);
  ...
  // optional .caffe.SelectSegBinaryParameter select_seg_binary_param = 50;
  inline bool has_select_seg_binary_param() const;
  inline void clear_select_seg_binary_param();
  static const int kSelectSegBinaryParamFieldNumber = 50;
  inline const ::caffe::SelectSegBinaryParameter& select_seg_binary_param() const;
  inline ::caffe::SelectSegBinaryParameter* mutable_select_seg_binary_param();
  inline ::caffe::SelectSegBinaryParameter* release_select_seg_binary_param();
  inline void set_allocated_select_seg_binary_param(::caffe::SelectSegBinaryParameter* select_seg_binary_param);
  ...
  // optional .caffe.WindowClsDataParameter window_cls_data_param = 49;
  inline bool has_window_cls_data_param() const;
  inline void clear_window_cls_data_param();
  static const int kWindowClsDataParamFieldNumber = 49;
  inline const ::caffe::WindowClsDataParameter& window_cls_data_param() const;
  inline ::caffe::WindowClsDataParameter* mutable_window_cls_data_param();
  inline ::caffe::WindowClsDataParameter* release_window_cls_data_param();
  inline void set_allocated_window_cls_data_param(::caffe::WindowClsDataParameter* window_cls_data_param);
 ...
 private:
  ...
  inline void set_has_binary_accuracy_param();
  inline void clear_has_binary_accuracy_param();
  ...
  inline void set_has_red_softmax_loss_param();
  inline void clear_has_red_softmax_loss_param();
  inline void set_has_red_accuracy_param();
  inline void clear_has_red_accuracy_param();
  inline void set_has_relu_param();
  inline void clear_has_relu_param();
  inline void set_has_select_seg_binary_param();
  inline void clear_has_select_seg_binary_param();
  ...
  inline void set_has_window_cls_data_param();
  inline void clear_has_window_cls_data_param();
  ...
  ::caffe::BinaryAccuracyParameter* binary_accuracy_param_;
  ...
  ::caffe::RedSoftmaxWithLossParameter* red_softmax_loss_param_;
  ::caffe::RedAccuracyParameter* red_accuracy_param_;
  ::caffe::ReLUParameter* relu_param_;
  ::caffe::SelectSegBinaryParameter* select_seg_binary_param_;
  ...
  ::caffe::WindowClsDataParameter* window_cls_data_param_;
...
class SelectSegBinaryParameter : public ::google::protobuf::Message {
 public:
  SelectSegBinaryParameter();
  virtual ~SelectSegBinaryParameter();

  SelectSegBinaryParameter(const SelectSegBinaryParameter& from);

  inline SelectSegBinaryParameter& operator=(const SelectSegBinaryParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const SelectSegBinaryParameter& default_instance();

  void Swap(SelectSegBinaryParameter* other);

  // implements Message ----------------------------------------------

  SelectSegBinaryParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const SelectSegBinaryParameter& from);
  void MergeFrom(const SelectSegBinaryParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional uint32 cls_label_base = 1 [default = 0];
  inline bool has_cls_label_base() const;
  inline void clear_cls_label_base();
  static const int kClsLabelBaseFieldNumber = 1;
  inline ::google::protobuf::uint32 cls_label_base() const;
  inline void set_cls_label_base(::google::protobuf::uint32 value);

  // @@protoc_insertion_point(class_scope:caffe.SelectSegBinaryParameter)
 private:
  inline void set_has_cls_label_base();
  inline void clear_has_cls_label_base();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 cls_label_base_;
  ...
  void InitAsDefaultInstance();
  static SelectSegBinaryParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class RedAccuracyParameter : public ::google::protobuf::Message {
 public:
  RedAccuracyParameter();
  virtual ~RedAccuracyParameter();

  RedAccuracyParameter(const RedAccuracyParameter& from);

  inline RedAccuracyParameter& operator=(const RedAccuracyParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const RedAccuracyParameter& default_instance();

  void Swap(RedAccuracyParameter* other);

  // implements Message ----------------------------------------------

  RedAccuracyParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const RedAccuracyParameter& from);
  void MergeFrom(const RedAccuracyParameter& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static RedAccuracyParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class ImageDataParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional int32 other_object_label = 17 [default = 0];
  inline bool has_other_object_label() const;
  inline void clear_other_object_label();
  static const int kOtherObjectLabelFieldNumber = 17;
  inline ::google::protobuf::int32 other_object_label() const;
  inline void set_other_object_label(::google::protobuf::int32 value);
  ...
  inline bool has_has_label() const;
  inline void clear_has_label();
  static const int kHasLabelFieldNumber = 13;
  inline bool has_label() const;
  inline void set_has_label(bool value);
 ...
 private:
  ...
  inline void set_has_ignore_label();
  inline void clear_has_ignore_label();
  inline void set_has_other_object_label();
  inline void clear_has_other_object_label();
  ...
  inline void set_has_has_label();
  inline void clear_has_has_label();
  ...
  ::google::protobuf::int32 ignore_label_;
  ::google::protobuf::int32 other_object_label_;
  int label_type_;
  bool shuffle_;
  bool is_color_;
  bool mirror_;
...
class RedSoftmaxWithLossParameter : public ::google::protobuf::Message {
 public:
  RedSoftmaxWithLossParameter();
  virtual ~RedSoftmaxWithLossParameter();

  RedSoftmaxWithLossParameter(const RedSoftmaxWithLossParameter& from);

  inline RedSoftmaxWithLossParameter& operator=(const RedSoftmaxWithLossParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const RedSoftmaxWithLossParameter& default_instance();

  void Swap(RedSoftmaxWithLossParameter* other);

  // implements Message ----------------------------------------------

  RedSoftmaxWithLossParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const RedSoftmaxWithLossParameter& from);
  void MergeFrom(const RedSoftmaxWithLossParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline bool has_class_num() const;
  inline void clear_class_num();
  static const int kClassNumFieldNumber = 1;
  inline ::google::protobuf::uint32 class_num() const;
  inline void set_class_num(::google::protobuf::uint32 value);

  // @@protoc_insertion_point(class_scope:caffe.RedSoftmaxWithLossParameter)
 private:
  inline void set_has_class_num();
  inline void clear_has_class_num();
  ...
  void InitAsDefaultInstance();
  static RedSoftmaxWithLossParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class WindowClsDataParameter : public ::google::protobuf::Message {
 public:
  WindowClsDataParameter();
  virtual ~WindowClsDataParameter();

  WindowClsDataParameter(const WindowClsDataParameter& from);

  inline WindowClsDataParameter& operator=(const WindowClsDataParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const WindowClsDataParameter& default_instance();

  void Swap(WindowClsDataParameter* other);

  // implements Message ----------------------------------------------

  WindowClsDataParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const WindowClsDataParameter& from);
  void MergeFrom(const WindowClsDataParameter& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static WindowClsDataParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.BinaryAccuracyParameter binary_accuracy_param = 48;
inline bool LayerParameter::has_binary_accuracy_param() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void LayerParameter::set_has_binary_accuracy_param() {
  _has_bits_[0] |= 0x00004000u;
}
inline void LayerParameter::clear_has_binary_accuracy_param() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void LayerParameter::clear_binary_accuracy_param() {
  if (binary_accuracy_param_ != NULL) binary_accuracy_param_->::caffe::BinaryAccuracyParameter::Clear();
  clear_has_binary_accuracy_param();
}
inline const ::caffe::BinaryAccuracyParameter& LayerParameter::binary_accuracy_param() const {
  return binary_accuracy_param_ != NULL ? *binary_accuracy_param_ : *default_instance_->binary_accuracy_param_;
}
inline ::caffe::BinaryAccuracyParameter* LayerParameter::mutable_binary_accuracy_param() {
  set_has_binary_accuracy_param();
  if (binary_accuracy_param_ == NULL) binary_accuracy_param_ = new ::caffe::BinaryAccuracyParameter;
  return binary_accuracy_param_;
}
inline ::caffe::BinaryAccuracyParameter* LayerParameter::release_binary_accuracy_param() {
  clear_has_binary_accuracy_param();
  ::caffe::BinaryAccuracyParameter* temp = binary_accuracy_param_;
  binary_accuracy_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_binary_accuracy_param(::caffe::BinaryAccuracyParameter* binary_accuracy_param) {
  delete binary_accuracy_param_;
  binary_accuracy_param_ = binary_accuracy_param;
  if (binary_accuracy_param) {
    set_has_binary_accuracy_param();
  } else {
    clear_has_binary_accuracy_param();
  }
...
// optional .caffe.RedSoftmaxWithLossParameter red_softmax_loss_param = 46;
inline bool LayerParameter::has_red_softmax_loss_param() const {
  return (_has_bits_[1] & 0x00000010u) != 0;
}
inline void LayerParameter::set_has_red_softmax_loss_param() {
  _has_bits_[1] |= 0x00000010u;
}
inline void LayerParameter::clear_has_red_softmax_loss_param() {
  _has_bits_[1] &= ~0x00000010u;
}
inline void LayerParameter::clear_red_softmax_loss_param() {
  if (red_softmax_loss_param_ != NULL) red_softmax_loss_param_->::caffe::RedSoftmaxWithLossParameter::Clear();
  clear_has_red_softmax_loss_param();
}
inline const ::caffe::RedSoftmaxWithLossParameter& LayerParameter::red_softmax_loss_param() const {
  return red_softmax_loss_param_ != NULL ? *red_softmax_loss_param_ : *default_instance_->red_softmax_loss_param_;
}
inline ::caffe::RedSoftmaxWithLossParameter* LayerParameter::mutable_red_softmax_loss_param() {
  set_has_red_softmax_loss_param();
  if (red_softmax_loss_param_ == NULL) red_softmax_loss_param_ = new ::caffe::RedSoftmaxWithLossParameter;
  return red_softmax_loss_param_;
}
inline ::caffe::RedSoftmaxWithLossParameter* LayerParameter::release_red_softmax_loss_param() {
  clear_has_red_softmax_loss_param();
  ::caffe::RedSoftmaxWithLossParameter* temp = red_softmax_loss_param_;
  red_softmax_loss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_red_softmax_loss_param(::caffe::RedSoftmaxWithLossParameter* red_softmax_loss_param) {
  delete red_softmax_loss_param_;
  red_softmax_loss_param_ = red_softmax_loss_param;
  if (red_softmax_loss_param) {
    set_has_red_softmax_loss_param();
  } else {
    clear_has_red_softmax_loss_param();
  }
...
// optional .caffe.RedAccuracyParameter red_accuracy_param = 47;
inline bool LayerParameter::has_red_accuracy_param() const {
  return (_has_bits_[1] & 0x00000020u) != 0;
}
inline void LayerParameter::set_has_red_accuracy_param() {
  _has_bits_[1] |= 0x00000020u;
}
inline void LayerParameter::clear_has_red_accuracy_param() {
  _has_bits_[1] &= ~0x00000020u;
}
inline void LayerParameter::clear_red_accuracy_param() {
  if (red_accuracy_param_ != NULL) red_accuracy_param_->::caffe::RedAccuracyParameter::Clear();
  clear_has_red_accuracy_param();
}
inline const ::caffe::RedAccuracyParameter& LayerParameter::red_accuracy_param() const {
  return red_accuracy_param_ != NULL ? *red_accuracy_param_ : *default_instance_->red_accuracy_param_;
}
inline ::caffe::RedAccuracyParameter* LayerParameter::mutable_red_accuracy_param() {
  set_has_red_accuracy_param();
  if (red_accuracy_param_ == NULL) red_accuracy_param_ = new ::caffe::RedAccuracyParameter;
  return red_accuracy_param_;
}
inline ::caffe::RedAccuracyParameter* LayerParameter::release_red_accuracy_param() {
  clear_has_red_accuracy_param();
  ::caffe::RedAccuracyParameter* temp = red_accuracy_param_;
  red_accuracy_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_red_accuracy_param(::caffe::RedAccuracyParameter* red_accuracy_param) {
  delete red_accuracy_param_;
  red_accuracy_param_ = red_accuracy_param;
  if (red_accuracy_param) {
    set_has_red_accuracy_param();
  } else {
    clear_has_red_accuracy_param();
  }
...
// optional .caffe.SelectSegBinaryParameter select_seg_binary_param = 50;
inline bool LayerParameter::has_select_seg_binary_param() const {
  return (_has_bits_[1] & 0x00000080u) != 0;
}
inline void LayerParameter::set_has_select_seg_binary_param() {
  _has_bits_[1] |= 0x00000080u;
}
inline void LayerParameter::clear_has_select_seg_binary_param() {
  _has_bits_[1] &= ~0x00000080u;
}
inline void LayerParameter::clear_select_seg_binary_param() {
  if (select_seg_binary_param_ != NULL) select_seg_binary_param_->::caffe::SelectSegBinaryParameter::Clear();
  clear_has_select_seg_binary_param();
}
inline const ::caffe::SelectSegBinaryParameter& LayerParameter::select_seg_binary_param() const {
  return select_seg_binary_param_ != NULL ? *select_seg_binary_param_ : *default_instance_->select_seg_binary_param_;
}
inline ::caffe::SelectSegBinaryParameter* LayerParameter::mutable_select_seg_binary_param() {
  set_has_select_seg_binary_param();
  if (select_seg_binary_param_ == NULL) select_seg_binary_param_ = new ::caffe::SelectSegBinaryParameter;
  return select_seg_binary_param_;
}
inline ::caffe::SelectSegBinaryParameter* LayerParameter::release_select_seg_binary_param() {
  clear_has_select_seg_binary_param();
  ::caffe::SelectSegBinaryParameter* temp = select_seg_binary_param_;
  select_seg_binary_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_select_seg_binary_param(::caffe::SelectSegBinaryParameter* select_seg_binary_param) {
  delete select_seg_binary_param_;
  select_seg_binary_param_ = select_seg_binary_param;
  if (select_seg_binary_param) {
    set_has_select_seg_binary_param();
  } else {
    clear_has_select_seg_binary_param();
  }
...
// optional .caffe.WindowClsDataParameter window_cls_data_param = 49;
inline bool LayerParameter::has_window_cls_data_param() const {
  return (_has_bits_[1] & 0x00004000u) != 0;
}
inline void LayerParameter::set_has_window_cls_data_param() {
  _has_bits_[1] |= 0x00004000u;
}
inline void LayerParameter::clear_has_window_cls_data_param() {
  _has_bits_[1] &= ~0x00004000u;
}
inline void LayerParameter::clear_window_cls_data_param() {
  if (window_cls_data_param_ != NULL) window_cls_data_param_->::caffe::WindowClsDataParameter::Clear();
  clear_has_window_cls_data_param();
}
inline const ::caffe::WindowClsDataParameter& LayerParameter::window_cls_data_param() const {
  return window_cls_data_param_ != NULL ? *window_cls_data_param_ : *default_instance_->window_cls_data_param_;
}
inline ::caffe::WindowClsDataParameter* LayerParameter::mutable_window_cls_data_param() {
  set_has_window_cls_data_param();
  if (window_cls_data_param_ == NULL) window_cls_data_param_ = new ::caffe::WindowClsDataParameter;
  return window_cls_data_param_;
}
inline ::caffe::WindowClsDataParameter* LayerParameter::release_window_cls_data_param() {
  clear_has_window_cls_data_param();
  ::caffe::WindowClsDataParameter* temp = window_cls_data_param_;
  window_cls_data_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_window_cls_data_param(::caffe::WindowClsDataParameter* window_cls_data_param) {
  delete window_cls_data_param_;
  window_cls_data_param_ = window_cls_data_param;
  if (window_cls_data_param) {
    set_has_window_cls_data_param();
  } else {
    clear_has_window_cls_data_param();
  }
...
// optional uint32 cls_label_base = 1 [default = 0];
inline bool SelectSegBinaryParameter::has_cls_label_base() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void SelectSegBinaryParameter::set_has_cls_label_base() {
  _has_bits_[0] |= 0x00000001u;
}
inline void SelectSegBinaryParameter::clear_has_cls_label_base() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void SelectSegBinaryParameter::clear_cls_label_base() {
  cls_label_base_ = 0u;
  clear_has_cls_label_base();
}
inline ::google::protobuf::uint32 SelectSegBinaryParameter::cls_label_base() const {
  return cls_label_base_;
}
inline void SelectSegBinaryParameter::set_cls_label_base(::google::protobuf::uint32 value) {
  set_has_cls_label_base();
  cls_label_base_ = value;
}
...
// optional uint32 top_k = 1 [default = 1];
inline bool RedAccuracyParameter::has_top_k() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void RedAccuracyParameter::set_has_top_k() {
  _has_bits_[0] |= 0x00000001u;
}
inline void RedAccuracyParameter::clear_has_top_k() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void RedAccuracyParameter::clear_top_k() {
  top_k_ = 1u;
  clear_has_top_k();
}
inline ::google::protobuf::uint32 RedAccuracyParameter::top_k() const {
  return top_k_;
}
inline void RedAccuracyParameter::set_top_k(::google::protobuf::uint32 value) {
  set_has_top_k();
  top_k_ = value;
}

// optional int32 ignore_label = 2;
inline bool RedAccuracyParameter::has_ignore_label() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void RedAccuracyParameter::set_has_ignore_label() {
  _has_bits_[0] |= 0x00000002u;
}
inline void RedAccuracyParameter::clear_has_ignore_label() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void RedAccuracyParameter::clear_ignore_label() {
  ignore_label_ = 0;
  clear_has_ignore_label();
}
inline ::google::protobuf::int32 RedAccuracyParameter::ignore_label() const {
  return ignore_label_;
}
inline void RedAccuracyParameter::set_ignore_label(::google::protobuf::int32 value) {
  set_has_ignore_label();
  ignore_label_ = value;
}

// optional uint32 class_num = 3;
inline bool RedAccuracyParameter::has_class_num() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void RedAccuracyParameter::set_has_class_num() {
  _has_bits_[0] |= 0x00000004u;
}
inline void RedAccuracyParameter::clear_has_class_num() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void RedAccuracyParameter::clear_class_num() {
  class_num_ = 0u;
  clear_has_class_num();
}
inline ::google::protobuf::uint32 RedAccuracyParameter::class_num() const {
  return class_num_;
}
inline void RedAccuracyParameter::set_class_num(::google::protobuf::uint32 value) {
  set_has_class_num();
  class_num_ = value;
}
...
// optional int32 other_object_label = 17 [default = 0];
inline bool ImageDataParameter::has_other_object_label() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void ImageDataParameter::set_has_other_object_label() {
  _has_bits_[0] |= 0x00000100u;
}
inline void ImageDataParameter::clear_has_other_object_label() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void ImageDataParameter::clear_other_object_label() {
  other_object_label_ = 0;
  clear_has_other_object_label();
}
inline ::google::protobuf::int32 ImageDataParameter::other_object_label() const {
  return other_object_label_;
}
inline void ImageDataParameter::set_other_object_label(::google::protobuf::int32 value) {
  set_has_other_object_label();
  other_object_label_ = value;
}
...
// optional uint32 class_num = 1;
inline bool RedSoftmaxWithLossParameter::has_class_num() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void RedSoftmaxWithLossParameter::set_has_class_num() {
  _has_bits_[0] |= 0x00000001u;
}
inline void RedSoftmaxWithLossParameter::clear_has_class_num() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void RedSoftmaxWithLossParameter::clear_class_num() {
  class_num_ = 0u;
  clear_has_class_num();
}
inline ::google::protobuf::uint32 RedSoftmaxWithLossParameter::class_num() const {
  return class_num_;
}
inline void RedSoftmaxWithLossParameter::set_class_num(::google::protobuf::uint32 value) {
  set_has_class_num();
  class_num_ = value;
}
...
// optional uint32 label_dim = 1 [default = 1];
inline bool WindowClsDataParameter::has_label_dim() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void WindowClsDataParameter::set_has_label_dim() {
  _has_bits_[0] |= 0x00000001u;
}
inline void WindowClsDataParameter::clear_has_label_dim() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void WindowClsDataParameter::clear_label_dim() {
  label_dim_ = 1u;
  clear_has_label_dim();
}
inline ::google::protobuf::uint32 WindowClsDataParameter::label_dim() const {
  return label_dim_;
}
inline void WindowClsDataParameter::set_label_dim(::google::protobuf::uint32 value) {
  set_has_label_dim();
  label_dim_ = value;
}
